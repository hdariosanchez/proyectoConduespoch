...
exports.get = function(cb) {      //Funcion que forma el modelo de estudiante: contexto-> Todos los estudiantes.
  var data = [];
  client.query("SELECT * FROM tblGstEstudiante")
    ...
    .on('end', function() {
      cb(data);
      console.log('Funcion get() desde modelGstEstudiante .on.End: OK');
    });
  //client.end();
    /*
    Client.prototype.destroy = function() {
      if (this.connected || this.connecting) {
        ...
        try {
          this._client.end();
          console.log('CLIENTE CERRADO CON END');
        } catch (e) {
          console.log(e);
        }
      } else {
        ...
        console.log('CLIENTE DESTRUIDO Y removeAllListeners');
      }
    };
    */
};
