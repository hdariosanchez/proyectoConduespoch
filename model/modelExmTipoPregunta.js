...
exports.get = function(cb) {      //Funcion que forma el modelo de TipoPregunta: contexto-> Todas los TipoPregunta.
  var data = [];
  client.query("SELECT intId, strDescripcion, strEstado FROM tblExmTipoPregunta;")
